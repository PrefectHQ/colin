...
**Providers**: Built-in providers connect to external sources: [GitHub](/providers/github) repositories and issues, [Linear](/providers/linear) issues, [Notion](/providers/notion) pages, [HTTP](/providers/http) endpoints, [S3](/providers/s3) buckets, and [MCP servers](/providers/mcp). Each provider tracks source versions for staleness detection.
