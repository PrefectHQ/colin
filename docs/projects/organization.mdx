...
| `output-path` | Compiled output directory | `output` |

For advanced output configuration including Claude Code integration, see [Output Targets](/running/configuration#output-targets).
