...
The frontmatter defines metadata about the document. The body contains Markdown content, optionally enhanced with Jinja templating for dynamic behavior. See [Templating](/templating/templating) for details on expressions, filters, LLM blocks, and other template features.
