...
{{ ref(mcp.github.resource('repo://owner/repo/README.md')).content }}
```
...
{{ mcp.github.resource('repo://owner/repo/README.md').content }}
```
...
{% set resource = ref(mcp.github.resource('repo://owner/repo/README.md')) %}
