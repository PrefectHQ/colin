...
When you compile a project, Colin stores the source project location and any `--var` overrides in the output manifest. Later, you can update those outputs without knowing where the source project lives—Colin reads the manifest and recompiles from the original source.
